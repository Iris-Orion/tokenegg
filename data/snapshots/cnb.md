<!-- https://docs.cnb.cool/zh/pricing.html fetched 2026-09-19T18:36:53.658Z -->
Title: 定价 | CNB 文档
...
| --- | --- | --- | --- |
| 仓库存储 | 100 GiB | ¥1/GiB/月 | Git 对象 |
| 对象存储 | 100 GiB | ¥1/GiB/月 | 制品、LFS 对象等 |
| 云原生构建-CPU | 160 核时/月 | ¥0.125/核时 | 云原生构建 CPU |
| 云原生开发-CPU | 1600 核时/月 | ¥0.125/核时 | 云原生开发 CPU |
| 云原生构建-GPU | 0 核时/月 | ¥0.5/核时 | 云原生构建 GPU |
| 云原生开发-GPU | 0 核时/月 | ¥0.5/核时 | 云原生开发 GPU |
| AI Credits | 500 credits/月 | ¥0.05/credit | NPC 等 AI Token |
...
符合条件的非营利组织，可申请永久免费使用特权，具体特权内容与申领方式以申领页面为准。

请公益慈善机构前往 [腾讯技术公益数字工具箱](https://techforgood.qq.com/tools/toolsDetail/11) 查看并完成申领。
