<!-- https://docs.coze.cn/coze_pro_credits fetched 2026-09-07T15:54:38.976Z -->
Title: 积分
...
[计费概述](https://docs.coze.cn/coze_pro_billing_overview)

[积分](https://docs.coze.cn/coze_pro_credits)
...
[开具发票](https://docs.coze.cn/coze_pro_Issue_invoice)

[账单与用量](https://docs.coze.cn/coze_pro_bills_and_usage)
...
以下特定资源**不支持**通过积分抵扣。在功能支持的范围内，企业版可通过账户余额、代金券等方式结算，个人版和团队版需扫码支付结算。
...
*   支持叠加购买，单独计算有效期。
*   个人版、团队版的增购积分不支持退款。
*   企业版的增购积分符合退订规则时，支持退订、退款。更多信息，请参考[退订规则](https://docs.coze.cn/coze_pro/enterprise_plan#hEdE8M8xT)。
...
请关注短信提醒并及时充值。个人版、团队版积分为 0 后，系统将停止服务，自动拦截扣子所有可能产生资源消耗的请求，包括但不限于开发 AI 编程项目、智能体调用、API 请求等。

你可以为企业版的增购积分设置余量阈值比例，以实际抵扣后的余量计算。在积分重置周期内，当余量低于你设置的阈值时将触发一次告警，并通过火山引擎站内信、邮件或短信的方式通知你，请关注通知提醒并及时充值。具体操作步骤如下：

说明

*   由于实际消耗的积分出账存在延时，因此余量预警通知也将存在延时。
...
*   [增购积分支持退款吗？](https://docs.coze.cn/coze_pro/billing_faq#c7dd200c)
*   [套餐到期后，账户里的积分还能用吗？](https://docs.coze.cn/coze_pro/billing_faq#d551ac2c)
*   [存量的扣子资源包还能用吗？](https://docs.coze.cn/coze_pro/billing_faq#1db70ea0)

Was this document helpful?

Helpful Not helpful

[Previous 计费概述](https://docs.coze.cn/coze_pro_billing_overview)[Next 企业版套餐定价调整](https://docs.coze.cn/guides_enterprise_plan_pricing_adjustment)

[什么是积分](https://docs.coze.cn/coze_pro_credits#f39a4eda "什么是积分")

[积分用途](https://docs.coze.cn/coze_pro_credits#dedd6edb "积分用途")

[获取方式和有效期](https://docs.coze.cn/coze_pro_credits#8a76d93b "获取方式和有效期")

[抵扣顺序](https://docs.coze.cn/coze_pro_credits#e808404a "抵扣顺序")

[购买积分](https://docs.coze.cn/coze_pro_credits#0a917c32 "购买积分")

[积分预警](https://docs.coze.cn/coze_pro_credits#47f0f711 "积分预警")

[失败任务补偿积分](https://docs.coze.cn/coze_pro_credits#ac31d302 "失败任务补偿积分")
...
[查看积分购买记录](https://docs.coze.cn/coze_pro_credits#af113a5a "查看积分购买记录")
